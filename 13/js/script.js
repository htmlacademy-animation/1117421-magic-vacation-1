  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        setTimeout(() => {
          Object(_first_result_animate__WEBPACK_IMPORTED_MODULE_0__["firstResultAnimate"])(targetEl[0].querySelector(`#resultPic`));
